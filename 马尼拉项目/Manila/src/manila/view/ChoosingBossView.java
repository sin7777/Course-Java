...
public class ChoosingBossView extends JFrame {
	...
	public ChoosingBossView(Game g, GameView gv){
		this.game = g;
		this.cbc = new ChoosingBossController(this, gv);
		...
		//////////////////////////////////////////////////////
		this.pvList = new PlayerView[this.game.getPlayers().size()];
		for(int i=0; i<this.game.getPlayers().size(); i++){
              this.pvList[i] = new PlayerView(this.game.getPlayers().get(i),false);
