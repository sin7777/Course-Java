...
public class Game {
	...
	public Game(GameView gv){
		...
		this.players[0] = new Player("Lilei", 0, Color.RED);
		this.players[1] = new Player("Lucy", 1, Color.GREEN);
		this.players[2] = new Player("Lily", 2, Color.BLUE);
	}
	...
	public void calculateProfits(){
		...
		for(Player p : this.players)
			this.gameV.updatePlayersView(p.getPid());
	}
